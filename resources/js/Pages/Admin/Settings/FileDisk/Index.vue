...
function destroy(id) {
  ...
  useForm({}).delete(route('admin.settings.file-disks.destroy', {file_disk: id}), {
                  ...
                  <tr v-for="(disk, index) in disks.data">
                    ...
                    <td class="pa-1">
                      <v-btn-toggle divided >
                        ...
                        <v-btn @click.stop="dialog = true" size="small" variant="outlined" color="primary" icon="mdi-trash"/>
                        <v-dialog
                          v-model="dialog"
                          max-width="290"
                        >
